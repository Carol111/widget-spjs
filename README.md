...
## ChiliPeppr Widget / Serial Port JSON Server Piezo
...
| chilipeppr.load() URL | http://raw.githubusercontent.com/Carol111/widget-spjs/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/ccm111/widget_serialport |
| Github URL            | http://github.com/Carol111/widget-spjs |
| Test URL              | https://preview.c9users.io/ccm111/widget_serialport/widget.html |
  ...
  function() {
    ...
    cprequire(
      ...
      function(myObjWidgetSerialport) {
        ...
        console.log("Widget / Serial Port JSON Server Piezo just got loaded.", myObjWidgetSerialport);
